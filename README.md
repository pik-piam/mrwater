...
R package **mrwater**, version **1.7.1**
...
Beier F, Heinke J, Karstens K, Bodirsky B, Dietrich J (2023). _mrwater: madrat based MAgPIE water Input Data Library_. R package version 1.7.1, <URL: https://github.com/pik-piam/mrwater>.
