...
R package **mrmagpie**, version **0.13.0**
...
Karstens K, Dietrich J, Chen D, Windisch M, Alves M, Beier F, v. Jeetze P, Mishra
A (2020). _mrmagpie: madrat based MAgPIE Input Data Library_. R package version
0.13.0.
