...
R package **mrwater**, version **1.6.15.9001**
...
Beier F, Heinke J, Karstens K, Bodirsky B, Dietrich J (2023). _mrwater: madrat based MAgPIE water Input Data Library_. R package version 1.6.15.9001, <https://github.com/pik-piam/mrwater>.
...
@Manual{,
  ...
  year = {2023},
  note = {R package version 1.6.15.9001},
