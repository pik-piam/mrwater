...
R package **mrwater**, version **1.3.4**
...
Beier F, Heinke J, Karstens K, Bodirsky B, Dietrich J (2022). _mrwater: madrat based MAgPIE water Input Data Library_. R package version 1.3.4, <URL: https://github.com/pik-piam/mrwater>.
