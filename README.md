...
R package **mrmagpie**, version **0.25.13**
...
Jeetze P, Mishra A, Humpenoeder F (2020). _mrmagpie: madrat based
MAgPIE Input Data Library_. R package version 0.25.13.
...
@Manual{,
  ...
  year = {2020},
  note = {R package version 0.25.13},
}
```
