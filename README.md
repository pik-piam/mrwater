...
R package **mrwater**, version **0.5.236**
...
Beier F, Heinke J, Karstens K, Dietrich J (2021). _mrwater: madrat based MAgPIE Input Data Library_. R package version 0.5.236.
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 0.5.236},
}
```
