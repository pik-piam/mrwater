...
R package **mrwater**, version **1.5.8**
...
Beier F, Heinke J, Karstens K, Bodirsky B, Dietrich J (2023). _mrwater: madrat based MAgPIE water Input Data Library_. R package version 1.5.8, <https://github.com/pik-piam/mrwater>.
