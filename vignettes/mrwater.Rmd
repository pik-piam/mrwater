...
The irrigation potentials can be calculated for various scenarios of potential cropland cover that are set via the ``landScen`` argument. It consists of three parts: (1) a selection of current cropland (currCropland) or potential cropland (potCropland); (2) a protection component (only relevant for the cropland expansion case, i.e. potCropland) separated by "_" from (1). WDPA, BH, FF, CPD, LW, HalfEarth can be selected as protection scenario; (3) initialization year of cropland area, separated by ":".
For example ``landScen = "currCropland:2010"`` selects current cropland extent as of the year 2010; ``landScen = "potIrrigRamankutty_HalfEarth:2010"`` is potential cropland while respecting a Half Earth land protection scenario. The year argument is ignored for the case of potCropland. It is only relevant for the currCropland case.
