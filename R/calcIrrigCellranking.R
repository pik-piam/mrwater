...
#' }
#'
calcIrrigCellranking <- function(lpjml, climatetype, cellrankyear, method, proxycrop, iniyear, yieldcalib, multicropping) {
  ...
  if (method == "meancellrank") {
    ...
    yield_gain <- calcOutput("IrrigYieldImprovementPotential", lpjml = lpjml, climatetype = climatetype, selectyears = cellrankyear, proxycrop = NULL, monetary = FALSE, iniyear = NULL, yieldcalib = yieldcalib, multicropping = multicropping, aggregate = FALSE)
    # select proxy crops
    ...
    ## Read in potential yield gain per cell (tons per ha)
    yield_gain <- calcOutput("IrrigYieldImprovementPotential", lpjml = lpjml, climatetype = climatetype, selectyears = cellrankyear, yieldcalib = yieldcalib, proxycrop = NULL, monetary = FALSE, iniyear = NULL, multicropping = multicropping, aggregate = FALSE)
    # select proxy crops
    yield_gain <- yield_gain[, , proxycrop]
    ...
    yield_gain <- calcOutput("IrrigYieldImprovementPotential", lpjml = lpjml, climatetype = climatetype, selectyears = cellrankyear, proxycrop = proxycrop, yieldcalib = yieldcalib, monetary = TRUE, iniyear = iniyear, multicropping = multicropping, aggregate = FALSE)
    ...
    watvalue <- calcOutput("IrrigWatValue", selectyears = cellrankyear, lpjml = lpjml, climatetype = climatetype, iniyear = iniyear, proxycrop = proxycrop, yieldcalib = yieldcalib, multicropping = multicropping, aggregate = FALSE)
    ...
    yield_gain <- calcOutput("IrrigYieldImprovementPotential", lpjml = lpjml, climatetype = climatetype, selectyears = cellrankyear, proxycrop = NULL, monetary = TRUE, iniyear = iniyear, yieldcalib = yieldcalib, multicropping = multicropping, aggregate = FALSE)
