...
calcIrrigatableArea <- function(selectyears, climatetype, conservationstatus, rankmethod, allocationrule, thresholdtype, gainthreshold, irrigationsystem, avlland_scen, proxycrop){
