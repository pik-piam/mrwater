...
#         inLIST <- list(irrigGain = irrigGain[c, y, , drop = FALSE],
#                        gainthreshold = gainthreshold,
#                        reqWatFullirrigWW = reqWatFullirrigWW[c, y, , drop = FALSE],
#                        reqWatFullirrigWC = reqWatFullirrigWC[, y, , drop = FALSE],

#                        )
#         inoutLIST <- list(discharge = discharge[, y, , drop = FALSE],
#                           reserved = minWatReserved[, y, , drop = FALSE],
#                           avlWatWW = avlWatWW[c, y, ],
#                           avlWatWC = avlWatWC[c, y, ])
