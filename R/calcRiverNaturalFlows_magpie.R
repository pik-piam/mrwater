...
calcRiverNaturalFlows_magpie <- function(selectyears, lpjml, climatetype) {
  ...
  lake_evap     <- collapseNames(setYears(calcOutput("LPJmL_new", version=lpjml["natveg"], subtype="lake_evap", climatetype=climatetype, stage=stage, years=selectyears, aggregate=FALSE), selectyears))
