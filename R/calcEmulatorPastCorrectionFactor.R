...
calcEmuPastCorrectFactor <-
  function(model_id = "20f33a2280", folder = "GrassYieldsEmulator") {
    ...
    # folder <- "C:/magpie_inputdata/sources/GrassYldEmu/20f33a2280"
    ...
    max_grass <- unlist(readRDS(path(folder, "max_harvest_20f33a2280.rds")))
    ...
    # luplot::plotmap2(correction_factor[, 1, ])
...
nchar("readSource(GrassYldEmu, subtype = GrassYldEmu:20f33a2280.max_harvest, convert=onlycorrect)")
