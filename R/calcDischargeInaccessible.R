...
calcDischargeInaccessible <- function(lpjml, selectyears, climatetype, accessibilityrule) {
  ...
  access_shr <- calcOutput("DischargeAccessibilityShare", lpjml=lpjml, selectyears=selectyears, climatetype=climatetype, accessibilityrule=accessibilityrule, aggregate=FALSE)
