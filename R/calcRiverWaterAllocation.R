...
calcRiverWaterAllocation <- function(selectyears, climatetype, allocationrule, thresholdtype, gainthreshold, irrigationsystem, iniyear, protect_scen) {
  ...
  #
  frac_fullirrig <- calcOutput("RiverSurplusDischargeAllocation", aggregate=FALSE, output="frac_fullirrig", selectyears=selectyears, climatetype=climatetype, allocationrule=allocationrule, thresholdtype=thresholdtype, gainthreshold=gainthreshold, irrigationsystem=irrigationsystem, iniyear=iniyear, protect_scen=protect_scen)

  # Discharge
  discharge <- calcOutput("RiverSurplusDischargeAllocation", aggregate=FALSE, output="discharge", selectyears=selectyears, climatetype=climatetype, allocationrule=allocationrule, thresholdtype=thresholdtype, gainthreshold=gainthreshold, irrigationsystem=irrigationsystem, iniyear=iniyear, protect_scen=protect_scen)

  NAg    <- calcOutput("calcRiverHumanUses", aggregate=FALSE, selectyears=selectyears, humanuse="non_agriculture", iniyear=iniyear, climatetype=climatetype)
  NAg_ww <- collapseNames(NAg[,,"withdrawal"])
  NAg_wc <- collapseNames(NAg[,,"consumption"])

  CAg    <- calcOutput("calcRiverHumanUses", aggregate=FALSE, selectyears=selectyears, humanuse="committed_agriculture", iniyear=iniyear, climatetype=climatetype)
