...
calcRiverHumanUses_ifandfor <- function(selectyears, humanuse, subtype, climatetype, EFRmethod) {
  # # # # # # # # # # #
  # # # READ IN DATA # #
  # # # # # # # # # # #
  ...
  for (EFP in c("on", "off")) {
    ...
    required_wat_min <- calcOutput("EnvmtlFlowRequirements", selectyears=selectyears, climatetype=climatetype, EFRmethod, aggregate=FALSE)
