...
plotSensitivityAccessibility <- function(x_axis_range, region = "GLO", output, scenario, lpjml, selectyears, iniyear, climatetype, efrMethod, rankmethod, yieldcalib, allocationrule, thresholdtype, irrigationsystem, landScen, cropmix, potential_wat = TRUE, com_ag, multicropping) {

  Q100  <- reportEconOfIrrig(GT_range = x_axis_range, region = region, output = output, scenario = scenario, iniyear = iniyear,
  ...
  Q075  <- reportEconOfIrrig(GT_range = x_axis_range, region = region, output = output, scenario = scenario, iniyear = iniyear, lpjml = lpjml, selectyears = selectyears, climatetype = climatetype,
  ...
  Q050  <- reportEconOfIrrig(GT_range = x_axis_range, region = region, output = output, scenario = scenario, lpjml = lpjml, selectyears = selectyears, iniyear = iniyear, climatetype = climatetype,
  ...
  Q025  <- reportEconOfIrrig(GT_range = x_axis_range, region = region, output = output, scenario = scenario, lpjml = lpjml, selectyears = selectyears, iniyear = iniyear, climatetype = climatetype,
  ...
  Q000  <- reportEconOfIrrig(GT_range = x_axis_range, region = region, output = output, scenario = scenario, lpjml = lpjml, selectyears = selectyears, iniyear = iniyear, climatetype = climatetype,
  ...
  CV2   <- reportEconOfIrrig(GT_range = x_axis_range, region = region, output = output, scenario = scenario, lpjml = lpjml, selectyears = selectyears, iniyear = iniyear, climatetype = climatetype,
