...
#' @param replace_years only to subset years for isimip replacement, to reduce memory requirement
...
# convert to array for memory
    yields <- as.array(yields[,rep,]); to_rep <- as.array(to_rep[,rep_years,])
