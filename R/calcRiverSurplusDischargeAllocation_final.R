...
calcRiverSurplusDischargeAllocation_final <- function(selectyears, output, climatetype, rankmethod, allocationrule, thresholdtype, gainthreshold, irrigationsystem, iniyear, avlland_scen, proxycrop) {
