...
calcRiverSurplusDischargeAllocation_final <- function(selectyears, output, climatetype, EFRmethod, variabilitythreshold, rankmethod, allocationrule, thresholdtype, gainthreshold, irrigationsystem, iniyear, avlland_scen, proxycrop) {
